package com.yunpuvip.pms.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.yunpuvip.pms.admin.common.persistence.model");
        packageConfig.setMapper("com.yunpuvip.pms.admin.common.persistence.dao");
        packageConfig.setXml("com.yunpuvip.pms.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.yunpuvip.pms.admin");
        contextConfig.setCoreBasePackage("com.yunpuvip.pms.core");
