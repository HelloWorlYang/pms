...
6. controller层采用map + warpper方式的返回结果，返回给前端更为灵活的数据，具体参见com.yunpuvip.pms.modular.system.warpper包中具体类。
...
9. 控制器层统一的异常拦截机制,利用@ControllerAdvice统一对异常拦截,具体见com.yunpuvip.pms.core.aop.GlobalExceptionHandler类。
...
```
@Configuration
@MapperScan(basePackages = {"com.yunpuvip.pms.modular.*.dao", "com.yunpuvip.pms.common.persistence.dao"})
